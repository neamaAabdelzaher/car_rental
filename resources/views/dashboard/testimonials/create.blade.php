...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form action="{{route('dashboard.testimonials.store')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                 @csrf
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" name="name" id="name" value="{{old('name')}}" required="required"  class="form-control ">
                        </div>
                    </div>
                    @error('name')
                    ...
                    <div class="item form-group mt-2">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" name="position" value="{{old('position')}}" required="required" id="position"  class="form-control ">
                        </div>
                    </div>
                    @error('position')
                    ...
                    <div class="item form-group mt-2">
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" {{ old('is_active') ? 'published':'' }}  name="published"  class="flat">
                            </label>
                        </div>
                    </div>
                    @error('published')
